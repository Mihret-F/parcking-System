...
void check()
	{
		if(rfid[0]=='1'&&rfid[1]=='8'&&rfid[2]=='1'&&rfid[3]=='8'&&rfid[4]=='1'&&rfid[5]=='8'&&rfid[6]=='1'&&rfid[7]=='8'&&rfid[8]=='1')
		{
		...
		else if(rfid[0]=='1'&&rfid[1]=='2'&&rfid[2]=='1'&&rfid[3]=='2'&&rfid[4]=='1'&&rfid[5]=='2'&&rfid[6]=='1'&&rfid[7]=='2'&&rfid[8]=='1')
		{
			lcdcmd(0x01);										//0x01 clears the LCD contents
			lcddis("ASSOCIATION MEMBER");		//String is displayed in the LCD
			lcdcmd("0xc0");									//0xc0 forces the cursor to beginning of second line
		...
		else if(rfid[0]=='0'&&rfid[1]=='0'&&rfid[2]=='0'&&rfid[3]=='0'&&rfid[4]=='0'&&rfid[5]=='0'&&rfid[6]=='0'&&rfid[7]=='0'&&rfid[8]=='0')
		{
			lcdcmd(0x01);										//0x01 clears the LCD contents
			lcddis("ASSOCIATION MEMBER");		//String is displayed in the LCD
			lcdcmd("0xc0");									//0xc0 forces the cursor to beginning of second line
		...
		else if(rfid[0]=='1'&&rfid[1]=='1'&&rfid[2]=='1'&&rfid[3]=='1'&&rfid[4]=='1'&&rfid[5]=='1'&&rfid[6]=='1'&&rfid[7]=='1'&&rfid[8]=='1')
		{
			lcdcmd(0x01);										//0x01 clears the LCD contents
			lcddis("ASSOCIATION MEMBER");		//String is displayed in the LCD
			lcdcmd("0xc0");									//0xc0 forces the cursor to beginning of second line
